...
private:
    ...
    ros::Subscriber ref_acceleration_sub_;
    ...
    geometry_msgs::Vector3 ref_velocity_data_;
    geometry_msgs::Vector3 angular_velocity_data_;
    geometry_msgs::Vector3 acceleration_data_;
    geometry_msgs::Vector3 ref_acceleration_data_;
    ...
    bool ref_velocity_received_;
    bool angular_velocity_received_;
    bool acceleration_received_;
    bool ref_acceleration_received_;
    ...
    void RefVelocityCallback(const geometry_msgs::Vector3::ConstPtr& msg);
    ...
    void RefAccelerationCallback(const geometry_msgs::Vector3::ConstPtr& msg);
