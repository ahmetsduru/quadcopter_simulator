function plot_rpy_t_degree(log_folder)
    ...
    % Euler açılarını dereceye çevirme
    actual_eul_deg = rad2deg(actual_eul); % Radyandan dereceye çevir
    ref_eul_deg = rad2deg(ref_eul);       % Radyandan dereceye çevir
    ...
    if ~isempty(actual_timestamp) && ~isempty(ref_timestamp)
        ...
        % Roll subplot
        subplot(3, 1, 1);
        plot(actual_timestamp, actual_eul_deg(:, 1), 'r', 'LineWidth', 1.5); % Actual roll kırmızı çizgi
        hold on;
        plot(ref_timestamp, ref_eul_deg(:, 1), 'k:', 'LineWidth', 1.5);      % Desired roll siyah kesikli çizgi
        ...
        % Pitch subplot
        subplot(3, 1, 2);
        plot(actual_timestamp, actual_eul_deg(:, 2), 'r', 'LineWidth', 1.5); % Actual pitch kırmızı çizgi
        hold on;
        plot(ref_timestamp, ref_eul_deg(:, 2), 'k:', 'LineWidth', 1.5);      % Desired pitch siyah kesikli çizgi
        xlabel('Normalized Timestamp (s)');
        ...
        % Yaw subplot
        subplot(3, 1, 3);
        plot(actual_timestamp, actual_eul_deg(:, 3), 'r', 'LineWidth', 1.5); % Actual yaw kırmızı çizgi
        hold on;
        plot(ref_timestamp, ref_eul_deg(:, 3), 'k:', 'LineWidth', 1.5);      % Desired yaw siyah kesikli çizgi
        xlabel('Normalized Timestamp (s)');
        ylabel('Yaw (degrees)');
